...
class F1Score(object):
    ...
    def __init__(self):
        ...
        self.url_map = {
            ...
            # "S-ORG":"http://127.0.0.1:5010/api/nlp/orgShort"
    ...
    def evaluate(self, model="org_per"):
        if model == "org_per":
            self.org_per()
        else:
            self.normal(model)
        ...
        for index, fetch in enumerate(data):
            ...
            for entity in entities:
                ...
                if entity.get("type") == "ORG":
                    ...
                    pre_per.append(tmp)
            per_tar_entities = self.get_tags(fetch, "PER", self.tag_map)
            ...
            for pre in pre_per:
                if pre in per_tar_entities:
                    ...
                    print(pre)
        self.f1_score(per_origin, per_found, per_right, "PER")
